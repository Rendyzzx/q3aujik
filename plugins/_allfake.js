...
handler.all = async function (m) {
	...
	try {
		...
		global.adReply = {
			contextInfo: {
				...
				externalAdReply: { // Bagian ini sesuka kalian berkreasi :'v
					...
					title: global.ucapan,
					body: `xʀ - ʙᴏᴛ`,
					mediaUrl: 'https://telegra.ph/file/615f65b6fc5ba05cfb6e4.jpg',
					description: 'XR-BOT',
					previewType: "PHOTO",
                    thumbnail: fs.readFileSync('./thumbnail.jpg'),
					//thumbnail: await (await fetch(pp)).buffer(),
					sourceUrl: "https://wa.me/6283181666350?text=HALO",					
				}
			}
		}
		global.fakeig = {
        ...
        global.fvn = {
            ...
            { remoteJid: "6283181666350-1625305606@g.us" } : {}) 
                       },
            message: { 
               "audioMessage": {
       ...
       key: {
                   fromMe: false,
                   participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "6283181666350@s.whatsapp.net" } : {})
               },
               message: {
                   "productMessage": {
                       "product": {
