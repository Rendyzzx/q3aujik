...
let wel = 'https://telegra.ph/file/9026e9a453f80b2c67104.mp4'

 let lea = 'https://telegra.ph/file/28e2cf49310b60f1beb82.mp4'
...
global.dfail = (type, m, conn) => {
    let msg = {
        rowner:'❌ sᴏʀʀʏ, ᴛʜɪs ᴄᴏᴍᴍᴀɴᴅ ᴄᴀɴ ᴏɴʟʏ ʙᴇ ᴜsᴇᴅ ʙʏ ᴛʜᴇ ʀᴇᴀʟ ᴏᴡɴᴇʀ',
		owner: '❌ sᴏʀʀʏ, ᴛʜɪs ᴄᴏᴍᴍᴀɴᴅ ᴄᴀɴ ᴏɴʟʏ ʙᴇ ᴜsᴇᴅ ʙʏ ᴛʜᴇ ᴏᴡɴᴇʀ',
		mods: '❌ sᴏʀʀʏ, ᴛʜɪs ᴄᴏᴍᴍᴀɴᴅ ᴄᴀɴ ᴏɴʟʏ ʙᴇ ᴜsᴇᴅ ʙʏ ᴍᴏᴅᴇʀᴀᴛᴏʀ',
		premium: '❌ sᴏʀʀʏ, ᴛʜɪs ᴄᴏᴍᴍᴀɴᴅ ɪs ғᴏʀ ᴘʀᴇᴍɪᴜᴍ ᴍᴇᴍʙᴇʀs ᴏɴʟʏ.',
		group: '❌ sᴏʀʀʏ, ᴛʜɪs ᴄᴏᴍᴍᴀɴᴅ ᴄᴀɴ ᴏɴʟʏ ʙᴇ ᴜsᴇᴅ ɪɴ ɢʀᴏᴜᴘs.',
		vip: '❌ sᴏʀʀʏ, ᴛʜɪs ᴄᴏᴍᴍᴀɴᴅ ɪs ғᴏʀ ᴠɪᴘ ᴍᴇᴍʙᴇʀs ᴏɴʟʏ.',
		private: '❌ sᴏʀʀʏ, ᴛʜɪs ᴄᴏᴍᴍᴀɴᴅ ᴄᴀɴ ᴏɴʟʏ ʙᴇ ᴜsᴇᴅ ɪɴ ᴘʀɪᴠᴀᴛᴇ ᴄʜᴀᴛ.',
		admin: '❌ sᴏʀʀʏ, ᴛʜɪs ᴄᴏᴍᴍᴀɴᴅ ɪs ᴏɴʟʏ ғᴏʀ ɢʀᴏᴜᴘ ᴀᴅᴍɪɴs.',
		botadmin: '❌ ᴍᴀᴋᴇ ᴛʜᴇ ʙᴏᴛ ᴀɴ ᴀᴅᴍɪɴ ᴛᴏ ᴜsᴇ ᴛʜɪs ᴄᴏᴍᴍᴀɴᴅ.',
        restrict: '❌ ᴛʜɪs ғᴇᴀᴛᴜʀᴇ ɪs ᴅɪsᴀʙʟᴇᴅ.'
    }[type]
    if (msg) return conn.sendMessage(m.chat, {
text: msg,
contextInfo: {
externalAdReply: {
title: 'ᴀ ᴄ ᴄ ᴇ s s - ᴅ ᴇ ɴ ɪ ᴇ ᴅ',
thumbnailUrl: 'https://telegra.ph/file/45364d0b2f53b368f53b1.jpg',
